...
<template>
    <Head title="Register - mNotify Point Tracking System">
    ...
    <div class="flex min-h-screen flex-col items-center bg-gradient-to-br from-orange-50 to-white p-6 text-gray-800 lg:justify-center lg:p-8 dark:from-orange-950 dark:to-gray-900 dark:text-orange-50">
        ...
        <main class="flex w-full max-w-md flex-col overflow-hidden rounded-xl bg-white p-8 shadow-xl dark:bg-gray-800">
            ...
            <!-- Title -->
            <h2 class="mb-2 text-center text-2xl font-bold text-orange-600 dark:text-orange-400">Create an account</h2>
            <p class="mb-6 text-center text-gray-600 dark:text-gray-300">
                Enter your details below to get started with mNotify Point Tracking System.
            </p>
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-6">
                ...
                <button
                    type="submit"
                    class="mt-2 inline-flex w-full items-center justify-center rounded-lg bg-orange-500 px-5 py-3 font-medium text-white transition-all hover:bg-orange-600 disabled:opacity-50 dark:bg-orange-600 dark:hover:bg-orange-700"
                    tabindex="5"
            ...
            <div class="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link :href="route('login')" :tabindex="6" class="font-medium text-orange-600 hover:underline dark:text-orange-400">
                    Log in
                </Link>
            </div>
        </main>
